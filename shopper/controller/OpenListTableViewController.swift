//
//  OpenListTableViewController.swift
//  shopper
//
//  Created by Chuck Pilon on 12/24/19.
...
class OpenListTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "Open Lists"
...
//        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "OpenListCell", for: indexPath)
...
//        }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let listItemTableViewController = segue.destination as? ListItemTableViewController
        listItemTableViewController?.list = self.fetchedResultsController.object(at: tableView.indexPathForSelectedRow!)
    }
}
