...
//  shopper
//
//  Created by Chuck Pilon on 1/6/20.
...
class StoresTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func insertNewObject(_ sender: Any) {
        performSegue(withIdentifier: "newStore", sender: self)
        
//        let alert = UIAlertController(title: "Alert", message: "TODO: StoresTableViewController.insertNewObject", preferredStyle: UIAlertController.Style.alert)
...
//        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        configureCell(cell, withStore: store)
        return cell
    }

    override func tableView(_ tableView: UITableView, canEditRowAt indexPath: IndexPath) -> Bool {
        // Return false if you do not want the specified store to be editable.
        return true
    }
...
//    }
    ...
    func controller(_ controller: NSFetchedResultsController<NSFetchRequestResult>, didChange anObject: Any, at indexPath: IndexPath?, for type: NSFetchedResultsChangeType, newIndexPath: IndexPath?) {
        ...
        switch type {
            ...
            case .update:
                configureCell(tableView.cellForRow(at: indexPath!)!, withStore: anObject as! Store)
            case .move:
                configureCell(tableView.cellForRow(at: indexPath!)!, withStore: anObject as! Store)
